...
namespace Unstable
{
    class Mob
    {
        ...
        {
            if (daneLauncher.daneMob[numerMoba].alive == true)
            {
                ...
                if (daneLauncher.daneMob[numerMoba].obraz.Top > daneLauncher.daneGracz[0].obraz.Top & daneLauncher.daneMob[numerMoba].wykonanoAtak == false) { daneLauncher.daneMob[numerMoba].up = true; }
                if (daneLauncher.daneMob[numerMoba].obraz.Bottom < daneLauncher.daneGracz[0].obraz.Bottom & daneLauncher.daneMob[numerMoba].wykonanoAtak == false) { daneLauncher.daneMob[numerMoba].down = true; }
                if (daneLauncher.daneMob[numerMoba].obraz.Left > daneLauncher.daneGracz[0].obraz.Right + 4 & daneLauncher.daneMob[numerMoba].wykonanoAtak == false) { daneLauncher.daneMob[numerMoba].left = true; }
                if (daneLauncher.daneMob[numerMoba].obraz.Right < daneLauncher.daneGracz[0].obraz.Left - 4 & daneLauncher.daneMob[numerMoba].wykonanoAtak == false) { daneLauncher.daneMob[numerMoba].right = true; }

                if (((daneLauncher.daneMob[numerMoba].obraz.Top > daneLauncher.daneGracz[0].obraz.Top & daneLauncher.daneMob[numerMoba].obraz.Top <= daneLauncher.daneGracz[0].obraz.Bottom + 8) | (daneLauncher.daneMob[numerMoba].obraz.Bottom < daneLauncher.daneGracz[0].obraz.Bottom & daneLauncher.daneMob[numerMoba].obraz.Bottom >= daneLauncher.daneGracz[0].obraz.Top - 8)) & daneLauncher.daneMob[numerMoba].obraz.Left <= daneLauncher.daneGracz[0].obraz.Right + 4 & daneLauncher.daneMob[numerMoba].obraz.Right >= daneLauncher.daneGracz[0].obraz.Left - 4 & daneLauncher.daneMob[numerMoba].wykonanoAtak == false)
                {
                    daneLauncher.daneMob[numerMoba].up = daneLauncher.daneMob[numerMoba].down = false;
                    if (!(daneLauncher.daneGracz[0].obraz.Left < (daneLauncher.poleGry.Left + 70)))
                    {
        ...
        public void AtakMoba(Timer timerMob,int numerMoba,int wartośćAtaku)
        {
            ...
            if(daneLauncher.daneMob[numerMoba].alive==true)
            {
                if (daneLauncher.daneMob[numerMoba].stopMoving == 0 & daneLauncher.daneMob[numerMoba].attack == false & (daneLauncher.daneMob[numerMoba].obraz.Left - daneLauncher.daneGracz[0].obraz.Right >= (-16) & daneLauncher.daneMob[numerMoba].obraz.Left - daneLauncher.daneGracz[0].obraz.Right < 8 & daneLauncher.daneGracz[0].obraz.Top - daneLauncher.daneMob[numerMoba].obraz.Top >= (-64) & daneLauncher.daneGracz[0].obraz.Top - daneLauncher.daneMob[numerMoba].obraz.Top < daneLauncher.daneMob[numerMoba].obraz.Height))
                {
                ...
                if (daneLauncher.daneMob[numerMoba].stopMoving == 0 & daneLauncher.daneMob[numerMoba].attack == false & (daneLauncher.daneGracz[0].obraz.Left - daneLauncher.daneMob[numerMoba].obraz.Right >= (-16) & daneLauncher.daneGracz[0].obraz.Left - daneLauncher.daneMob[numerMoba].obraz.Right < 8 & daneLauncher.daneGracz[0].obraz.Top - daneLauncher.daneMob[numerMoba].obraz.Top >= (-64) & daneLauncher.daneGracz[0].obraz.Top - daneLauncher.daneMob[numerMoba].obraz.Top < daneLauncher.daneMob[numerMoba].obraz.Height))
                {
                ...
                {
                    daneLauncher.daneGracz[0].hp -= metodaUniwersalne.dmgZwarcieMob(wartośćAtaku);
